...
In Chromium-based browsers, extension shortcuts will take precedence over browser-native
ones and over page shortcuts.
...
To manage extension shortcuts, open the extension management or go to `about:addons`,
click the cog button at the top right corner and select **Manage Extension Shortcuts**.
